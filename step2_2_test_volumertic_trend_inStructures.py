...
# main_path = '/media/fjr/My Passport/data/OASIS3/'
# fpath = main_path + 'all_npz/'

# path of templates
# model_name = 'Ep300'
# templates_path = '/home/fjr/data/trained_models/Atlas-GAN/plots/epoch300/my_plot_1e-4/'
# templates_path = '/home/fjr/data/trained_models/Atlas-GAN/plots_mixed/epoch300/my_plot_5e-4/'
# templates_path = '/home/fjr/data/trained_models/syc/Atlas-GAN/HC_only/plots/my_plot_1e-4/'
# model_name = 'Ep300_HConly' # 'MixedEp300_templatesonly'
# templates_path = '/home/fjr/data/trained_models/Atlas-GAN/my_plot_1e-4/corrected_nii/'
...
if __name__ == "__main__":
    # =========== use MAIA ======================
    # overall parameters - path of real data
    main_path = '/home/data/jrfu/data/OASIS3/' # '/home/data/jrfu/data/OASIS3/'
    fpath = main_path + 'all_npz/'
    ...
    for case in range(6,7):
        if case == 0:
            # -- HConly model --
            templates_path = '/home/data/jrfu/data/trained_models/HC_only/plots/my_plot_1e-4/' # sharpest
            model_name = 'Ep300_HConly_synthSegAll'
        elif case == 1:
            # -- Mixed 300ep model --
            templates_path = '/home/data/jrfu/data/trained_models/Mixed/epoch300/my_plot_5e-4/'  # sharpest
            model_name = 'Ep300_Mixed_synthSegAll'
        elif case == 2:
            # -- Mixed 200ep model --
            templates_path = '/home/data/jrfu/data/trained_models/Mixed/epoch200/my_plot_5e-4/'  # sharpest
            model_name = 'Ep200_Mixed_synthSegAll'
        elif case == 3:
            # -- 300ep model --
            templates_path = '/home/data/jrfu/data/trained_models/Real/epoch300/my_plot_1e-4/'  # sharpest
            model_name = 'Ep300_Real_synthSegAll'
        elif case == 4:
            # --200ep model --
            templates_path = '/home/data/jrfu/data/trained_models/Real/epoch200/'  # sharpest my_plot_1e-4/
            model_name = 'Ep200_Real_synthSegAll'
        elif case == 5:
            # -- ADonly model --
            templates_path = '/home/data/jrfu/data/trained_models/AD_only/my_plot_1e-4/'  # sharpest
            model_name = 'Ep300_ADonly_synthSegAll'
        elif case == 6:
            # -- HConly model --
            templates_path = '/home/data/jrfu/data/trained_models/HC_only/plots/my_plot_1e-4/'  # sharpest
            model_name = 'Ep300_HConly_synthSegAll'
        ...
        # labels for ventricles are: Left_Lateral_Ventricle(4); 3rd_Ventricle(14); 4th_Ventricle(15); Right_Lateral_Ventricle(43)
        ...
        # img_paths.extend(read_csv("test")[0]) # should be 473 images
        # img_cohorts.extend(read_csv("test")[1])
        #
        # img_paths_test = img_paths
        # img_cohorts_test = img_cohorts
        #
        # img_paths_train, img_cohorts_train = read_csv("train")
        # # ventricles
        # save_path_name = f'./figs/ventricles_syntheSeg{model_name}.pdf'
        # draw_final_plot_given_labels1(labels_ventricles, img_paths_test, img_cohorts_test, img_paths_train, img_cohorts_train, save_path_name)
        #
        # # hippocampus
        # save_path_name = f'./figs/hippocampus_syntheSeg{model_name}.pdf'
        # draw_final_plot_given_labels1(labels_hippocampus, img_paths_test, img_cohorts_test, img_paths_train, img_cohorts_train, save_path_name)
        #
        # # WM
        # save_path_name = f'./figs/WM_syntheSeg1{model_name}.pdf'
        # draw_final_plot_given_labels1(labels_WM, img_paths_test, img_cohorts_test, img_paths_train, img_cohorts_train, save_path_name)
        #
        # # brain_stem
        # save_path_name = f'./figs/BrainStem_syntheSeg{model_name}.pdf'
        # draw_final_plot_given_labels1(labels_brain_stem, img_paths_test, img_cohorts_test, img_paths_train, img_cohorts_train, save_path_name)
        ...
        # img_paths.extend(read_train_AD_csv("train")[0]) # train
        # img_cohorts.extend(read_train_AD_csv("train")[1])
        # model_name = model_name+'withallAD'
...
# # ventricles
# save_path_name = './figs/ventricles_syntheSeg.pdf'
# draw_final_plot_given_labels(labels_ventricles, save_path_name)
#
# # GM
# save_path_name = './figs/hippocampus_syntheSeg.pdf'
# draw_final_plot_given_labels(labels_hippocampus, save_path_name)
#
# # WM
# save_path_name = './figs/WM_syntheSeg.pdf'
# draw_final_plot_given_labels(labels_WM, save_path_name)
#
# # CSF
# save_path_name = './figs/brain_stem_syntheSeg.pdf'
# draw_final_plot_given_labels(labels_brain_stem, save_path_name)
...
#
# # WM
# save_path_name = f'./figs/WM_syntheSeg{model_name}.pdf'
# draw_final_plot_given_labels(labels_WM, save_path_name)
#
# # CSF
# save_path_name = f'./figs/brain_stem_syntheSeg{model_name}.pdf'
# draw_final_plot_given_labels(labels_brain_stem, save_path_name)
...
# # ventricles
# save_path_name = f'./figs/ventricles_syntheSeg{model_name}.pdf'
# draw_final_plot_given_labels_usingSynthSeg(labels_ventricles, img_paths_test, img_cohorts_test, save_path_name)
#
# # hippocampus
# save_path_name = f'./figs/hippocampus_syntheSeg{model_name}.pdf'
# draw_final_plot_given_labels_usingSynthSeg(labels_hippocampus, img_paths_test, img_cohorts_test, save_path_name)
#
# # WM
# save_path_name = f'./figs/WM_syntheSeg1{model_name}.pdf'
# draw_final_plot_given_labels_usingSynthSeg(labels_WM, img_paths_test, img_cohorts_test,  save_path_name)
#
# # brain_stem
# save_path_name = f'./figs/BrainStem_syntheSeg{model_name}.pdf'
# draw_final_plot_given_labels_usingSynthSeg(labels_brain_stem, img_paths_test, img_cohorts_test, save_path_name)
